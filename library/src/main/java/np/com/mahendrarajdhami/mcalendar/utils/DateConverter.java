...
public class DateConverter {
    ...
    private void initializeData() {
        Log.i("DateConverter", "initializeData");
...
//        if (daysInMonthMap != null) return daysInMonthMap;
        ...
        Log.i("Date Converter","daysInMonthMap");
    }
    ...
    private void getStartWeekDayMonthMap() {
        ...
        Log.i("Date Converter","startWeekDayMonthMap");
     ...
     */
    public Model getNepaliDate(@IntRange(from = 1913 - 2033) int engYY, @IntRange(from = 1, to = 12) int engMM, @IntRange(from = 1, to = 31) int engDD) {
        ...
        if (isEngDateInConversionRange(engYY, engMM, engDD)) {
            ...
            */
            ...
            Log.i("DateConverter","getNepaliDate");
    ...
    public Model getNepaliDate(Calendar date) {
        int tempYear = date.get(Calendar.YEAR);
        int tempMonth = date.get(Calendar.MONTH)+1;
        int tempDayOfMonth = date.get(Calendar.DAY_OF_MONTH);
        Model tempModel = getNepaliDate(tempYear, tempMonth, tempDayOfMonth);
        return tempModel;
    }
