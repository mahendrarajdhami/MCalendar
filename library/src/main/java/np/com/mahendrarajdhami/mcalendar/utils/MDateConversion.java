...
public class MDateConversion {
    ...
    */
    ...
    public static String getNepaliDate(int engYear, int engMonth, int engDay, String currentLangID,int returnType) {
        ...
        String resultDate = nepYear +"-"+nMonthMap.get(nepMonth)+"-"+nepDay;
        if(returnType ==1){
            return String.valueOf(nepYear);
        } else if(returnType == 2){
            return String.valueOf(nepMonth);
        } else if(returnType == 3){
            return String.valueOf(nepDay);
        } else {
